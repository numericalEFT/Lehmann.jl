...
# function update(Λ, D, Nfine, q, grid, fineGrid, residual)
#     @inbounds for idx in 1:Nfine^D
...
#                 tiny = FloatL(1e-4)
#                 ω1, ω2 = grid[j, 1] + g[1], grid[j, 2] + g[2]
#                 if ω1 < tiny || ω2 < tiny
#                     kk = FloatL(0.5)
...
function updateResidual!(basis, projector)
    ...
    # @cuda update(Λ, D, Nfine, q, grid, fineGrid, residual)
